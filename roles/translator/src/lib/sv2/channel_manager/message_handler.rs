...
use roles_logic_sv2::{
    ...
    handlers_sv2::{HandlerError, ParseMiningMessagesFromUpstreamAsync},
    mining_sv2::{
...
impl ParseMiningMessagesFromUpstreamAsync<Downstream> for ChannelManager {
    fn get_channel_type(&self) -> roles_logic_sv2::handlers_sv2::SupportedChannelTypes {
