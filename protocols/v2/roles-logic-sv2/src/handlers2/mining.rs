...
#[trait_variant::make(ParseMiningMessagesFromDownstreamAsync: Send)]
...
#[trait_variant::make(ParseMiningMessagesFromUpstreamAsync: Send)]
...
// // #[trait_variant::make(ParseMiningMessagesFromDownstreamAsyncMulti: Send)]
// pub trait ParseMiningMessagesFromDownstreamAsync<Up: D>
// where
//     Self: Sized + D,
// {
//     async fn get_channel_type(&self) -> SupportedChannelTypes;
//     async fn is_work_selection_enabled(&self) -> bool;

//     async fn is_downstream_authorized(&self, user_identity: &binary_sv2::Str0255) -> Result<bool,
// Error>;

//     async fn handle_mining_message(&mut self, message: Mining) -> Result<(), Error> {
//         let (channel_type, work_selection) =
//             (self.get_channel_type(), self.is_work_selection_enabled());
...
//                 | SupportedChannelTypes::Group
//                 | SupportedChannelTypes::GroupAndExtended =>
// self.handle_submit_shares_standard(m),                 SupportedChannelTypes::Extended =>
// Err(Error::UnexpectedMessage(                     MESSAGE_TYPE_SUBMIT_SHARES_STANDARD,
//                 )),
//             },
...
//     async fn handle_submit_shares_standard(&mut self, msg: SubmitSharesStandard) -> Result<(),
// Error>;

//     async fn handle_submit_shares_extended(&mut self, msg: SubmitSharesExtended) -> Result<(),
// Error>;

//     async fn handle_set_custom_mining_job(&mut self, msg: SetCustomMiningJob) -> Result<(),
// Error>; }

// // #[trait_variant::make(ParseMiningMessagesFromUpstreamAsyncMulti: Send)]
...
//                 | SupportedChannelTypes::Group
//                 | SupportedChannelTypes::GroupAndExtended =>
// self.handle_new_extended_mining_job(m),                 _ => Err(Error::UnexpectedMessage(
//                     MESSAGE_TYPE_NEW_EXTENDED_MINING_JOB,
//                 )),
//             },
...
//     async fn handle_update_channel_error(&mut self, msg: UpdateChannelError) -> Result<(),
// Error>;

//     async fn handle_close_channel(&mut self, msg: CloseChannel) -> Result<(), Error>;

//     async fn handle_set_extranonce_prefix(&mut self, msg: SetExtranoncePrefix) -> Result<(),
// Error>;

//     async fn handle_submit_shares_success(&mut self, msg: SubmitSharesSuccess) -> Result<(),
// Error>;
...
//     async fn handle_new_extended_mining_job(&mut self, msg: NewExtendedMiningJob) -> Result<(),
// Error>;
